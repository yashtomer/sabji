  ...
  return (
    <div className="card-warm anim-scale-in flex flex-col">
      ...
      <div className="relative aspect-square bg-sand overflow-hidden">
        ...
        {badge && (
          <div
            ...
            style={{ top: 10, left: 10, padding: '3px 10px', borderRadius: 8, fontSize: 8, letterSpacing: '0.08em' }}
          >
            {badge.label}
          </div>
        )}
      ...
      <div className="flex flex-col flex-1" style={{ padding: 12 }}>
        <h3 className="font-display font-700 text-soil truncate" style={{ fontSize: 12.5, lineHeight: 1.2 }}>{product.name}</h3>
        <p className="font-body text-muted" style={{ fontSize: 10, marginTop: 2, marginBottom: 10 }}>{product.unit}</p>
